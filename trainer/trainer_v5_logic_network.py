...
if __name__ == "__main__":
    ...
    for batch in tqdm(dataloader):
        ...
        vlm_inputs = processor(p1,images[0], return_tensors="pt").to('cuda:0')
        output = vlm_model.generate(**vlm_inputs,max_new_tokens=100)
        ...
        inputs = processor(p2, images[0], return_tensors="pt").to('cuda:0')
        output = vlm_model.generate(**inputs, max_new_tokens=250)
        ...
        for ans in answer_candidates:
            ...
            for premise in generated_text:
                ...
                inputs = processor(p3, images[0], return_tensors="pt").to('cuda')
        ...
        all_predict_data_path = os.path.join(opt.logger_path, f'okvqa_predict.json')
