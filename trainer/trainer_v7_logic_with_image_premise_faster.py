...
def main():
    ...
    for batch in tqdm(dataloader):
        ...
        for c2 in object_candidate:
            ...
            for answer in answer_candidate:
                p1_p = prompt.LLAVA_PROMPT_FORMAT_ANSWER_PREMISE.format(question=question[0], answer=answer, object=c2.lower())
        ...
        if opt.inference_model =='vlm':
            ...
            c3 = prompt.LLM_PROMPT_FORMAT_FINAL_ANSWER.format(question=question[0], premise=str(new_premise))
