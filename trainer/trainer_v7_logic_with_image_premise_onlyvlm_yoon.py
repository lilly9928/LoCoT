...
from options_yoon import Options
...
def main():
    ...
    for batch in tqdm(dataloader):
        ...
        if opt.prompt =="long_cot":
            c3 = prompt.VLM_PROMPT_FORMAT_FINAL_ANSWER_onlyvlm_long_cot.format(question=question[0])
        elif opt.prompt=="cot":
            c3 = prompt.VLM_PROMPT_FORMAT_FINAL_ANSWER_onlyvlm_cot.format(question=question[0])
        elif opt.prompt=="no":
