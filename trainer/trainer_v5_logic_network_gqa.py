...
def main():
    ...
    train_examples = data.loadFile(
        '/data2/NS/GQA/preprocess/all_testdev_data.json'
    )

    print(len(train_examples['questions']))
    ...
    # 데이터로더 초기화
    dataloader = DataLoader(subset, batch_size=opt.per_gpu_batch_size, sampler=DistributedSampler(subset), shuffle=False,
    ...
    for batch in tqdm(dataloader):
        ...
        all_predict_data_path = os.path.join(opt.logger_path, f'gqa_predict_ddp_v2_.json')
