...
def main():
    ...
    for batch in tqdm(dataloader):
        ...
        for ans in answer_candidate:
            ...
            llm_premise[ans] += generated_text
        ...
        all_predict_data.append({
                ...
                "vlm_premise":vlm_premise,
                "llm_premise":llm_premise,
                "all_premise": premise_for_answer,
                
            })
        
        torch.distributed.barrier()

    temp_save_path = os.path.join(opt.logger_path,opt.name, f'temp_premise_rank_{local_rank}.json')
